...
export const AGENTS: MaestroAgent[] = [
  ...
  },
  {
    ...
    specialty: 'Transforme un visuel validé en reel 5-10 s pour Instagram et TikTok.',
    order: 8,
    inputs: ['image validée', 'caption', 'son optionnel'],
    outputs: ['vidéo MP4', 'format multi-ratio'],
    qualityChecks: ['mouvement naturel', 'pas de glitch', 'durée plateforme'],
    status: 'planned',
    model: 'Luma · Kling · Runway',
    emoji: '🎬',

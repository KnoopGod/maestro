...
export function TopBar() {
  return (
    <header className="fixed top-0 left-0 lg:left-64 right-0 h-14 bg-gray-950/80 backdrop-blur-xl border-b border-gray-800/50 flex items-center px-4 lg:px-6 z-30">
      {/* Search — WCAG 3.3.2 : label associé */}
      <div className="flex-1 max-w-md relative">
        ...
        />
        <kbd aria-hidden="true" className="absolute right-3 top-1/2 -translate-y-1/2 text-[10px] text-gray-600 bg-gray-800/50 border border-gray-700 rounded px-1.5 py-0.5">⌘K</kbd>
      </div>
      ...
      <div className="ml-auto flex items-center gap-2">
        ...
        >
          ...
          <span aria-hidden="true" className="absolute top-1.5 right-1.5 w-2 h-2 rounded-full bg-pink-500" />
        </button>

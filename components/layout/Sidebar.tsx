...
const NAV_WORK = [
  ...
  { href: '/campaigns',  icon: Megaphone,    label: 'Campagnes',  seq: '06', badge: 'ADS' },
  { href: '/plan',       icon: CalendarDays, label: 'Historique', seq: '07', badge: null },
  { href: '/agents',     icon: Bot,          label: 'Agents',     seq: '08', badge: null },
  { href: '/production', icon: Activity,     label: 'Production', seq: '09', badge: 'LIVE' },
  { href: '/analytics',  icon: BarChart3,    label: 'Analytics',  seq: '10', badge: null },
  { href: '/library',    icon: FolderOpen,   label: 'Library',    seq: '11', badge: null },
]

const NAV_SYSTEM = [
  { href: '/connections', icon: Plug,       label: 'Connexions', seq: '12', dot: true  },

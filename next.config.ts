...
const securityHeaders = [
  ...
  // until we add nonce-based CSP (Phase 6).
  {
    ...
    value: [
      ...
      "img-src 'self' data: blob: https://graph.facebook.com https://*.fbcdn.net https://*.cdninstagram.com https://oaidalleapiprodscus.blob.core.windows.net",
      "media-src 'self' blob: https://oaidalleapiprodscus.blob.core.windows.net",
      "font-src 'self'",

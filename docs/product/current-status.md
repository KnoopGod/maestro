...
| AI Router Phase A | `lib/ai/` — types, registry providers, router tasks→modèles, calcul coûts (spec 139) | ✅ |
...
- AI Router Phase B : page UI `Paramètres → IA & Modèles` (providers configurés, capacités disponibles)
- AI Router Phase C : Profit Controller branché au router, règles coût par tier client
